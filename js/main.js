...
if(document.getElementById("nic1").checked==true || document.getElementById("nic2").checked==true)
{
}
else
{
a.forEach(radio=> {  if(radio.checked)
{
if(radio.value==="ax1")
c=ax;    
...
b.forEach(radio=> {  if(radio.checked)
    {
    if(radio.value==="ax2")
    d=ax;    
...
if(document.getElementById("nic3").checked==true || document.getElementById("nic4").checked==true)
{
}
else
{
   e.forEach(radio=> {  if(radio.checked)
      {
         if(radio.id==="ah1")
...
f.forEach(radio=> {  if(radio.checked)
   {
